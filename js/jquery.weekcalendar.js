   ...
   $.widget("ui.weekCalendar", {
      ...
      _setupEventCreationForWeekDay : function($weekDay) {
         ...
         $weekDay.mousedown(function(event) {
            ...
            if ($newEvent.length) {
               ...
               $newEvent.remove();
               var newCalEvent = {start: eventDuration.start, end: eventDuration.end, title: options.newEventText, instructor:options.newEventText, location:options.newEventText, type:options.newEventText};
      ...
      _renderEvent: function (calEvent, $weekDay) {
         ...
         eventHtml = "<div class=\"" + eventClass + " ui-corner-all\">\
                ...
                <div class=\"wc-title\"></div><div class=\"wc-instructor\"></div><div class=\"wc-location\"></div><div class=\"wc-type\"></div></div>";
      ...
      _refreshEventDetails : function(calEvent, $calEvent) {
         ...
         $calEvent.find(".wc-instructor").html(calEvent.instructor);
         $calEvent.find(".wc-location").html(calEvent.location);
         $calEvent.find(".wc-type").html(calEvent.type);
